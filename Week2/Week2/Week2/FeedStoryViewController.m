...
//  Week2
//
//  Created by Daniel Warner Smith on 2/23/14.
...
- (void)viewDidLoad{
    ...
    self.timestamp.text = @"February 1 at 12:00pm";
    ...
    self.status.text = @"Apple releases giant squirrel to rave reviews";
    [self.card addSubview:self.status];
    
    self.photo = [[UIImageView alloc] initWithFrame:CGRectZero];
    self.photo.image = [UIImage imageNamed:@"apps2"];
    ...
    self.likeCount.text = @"236 people like this";
...
- (void)viewDidLayoutSubviews {
    ...
    _card.frame = CGRectMake(10, 10, 300, 396);
    ...
    CGSize contentSize = CGSizeMake(_storyArea.bounds.size.width, CGRectGetMaxY(_card.frame)+ 80);
